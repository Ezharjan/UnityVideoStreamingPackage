...
internal struct H264EncoderPlugin
{
    [DllImport("H264Encoder", EntryPoint ="Create")]
    extern public static IntPtr CreateEncoder(uint width, uint height, uint frameRateNumerator, uint frameRateDenominator, uint averageBitRate);
